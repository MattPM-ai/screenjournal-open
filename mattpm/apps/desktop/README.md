...
2. Click the **+** button or toggle switch for "MattPM Tracker"
...
```bash
codesign --verify --verbose /Applications/MattPM\ Tracker.app
```

**Display signature information:**
```bash
codesign --display --verbose=4 /Applications/MattPM\ Tracker.app
```

**Check entitlements:**
```bash
codesign --display --entitlements - /Applications/MattPM\ Tracker.app
```
