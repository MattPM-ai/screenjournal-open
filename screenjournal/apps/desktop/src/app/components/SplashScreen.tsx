 ...
 * 
 * Displays an initial loading splash screen with the ScreenJournal logo,
...
// ScreenJournal logo SVG component
const SplashLogo = () => (
...
export const SplashScreen = () => (
  <div id="splash-screen">
    <SplashLogo />
    <div className="splash-name">ScreenJournal Tracker</div>
